...
class UpdateTextCorpusView:
    ...
    def run(self):
        ...
        uploaded_texts = st.file_uploader(label='Upload texts here',
        ...
        update_corpus_btn = st.button(label='Upload texts to corpus',
                                      ...
                                      on_click=lambda: self._update_text_corpus(uploaded_texts))
    
    def _update_text_corpus(self, uploaded_files):
        st.session_state.get('text_corpus_uploader').upload_texts(uploaded_files)
